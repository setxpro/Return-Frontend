...
const FeedbackSuccessStep: React.FC<FeedbackSuccessStepProps> = ({ onFeedbackRestartRequest }) => {
  return (
    <>
      <header>
        <CloseButton/>
      ...
      <button 
        type="button" 
        className='py-2 px-6 mt-6 bg-zinc-800 rounded-md border-transparent text-sm leading-6 hover:bg-zinc-700 transition-colors focus:border-brand-500 focus:ring-brand-500 focus:outline-none focus:ring-1 '
